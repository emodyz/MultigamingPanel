<template>
  <div>
    <div class="p-6 sm:px-20 bg-white border-b border-gray dark:border-b dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-100">
      <div>
        <!-- <jet-application-logo class="block h-12 w-auto"/>-->
      </div>

      <div class="mt-8 text-2xl text-indigo-400">
        Welcome to your Jetstream application!
      </div>

      <div class="mt-6 text-zinc-500 dark:text-zinc-100">
    ...
    <!--
    <div class="bg-zinc-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
      <div class="p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4 text-lg text-zinc-600 leading-7 font-semibold">
      ...
      <div class="p-6 border-t border-zinc-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
          <svg
            fill="none"
            stroke="currentColor"
      ...
      <div class="p-6 border-t border-zinc-200 md:border-l">
        <div class="flex items-center">
          <svg
            fill="none"
            stroke="currentColor"
