<template>
  <div>
    <div class="p-6 sm:px-20 bg-white border-b border-gray dark:border-b dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100">
      <div>
      ...
      <div class="mt-6 text-gray-500 dark:text-gray-100">
