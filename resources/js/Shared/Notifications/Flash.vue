...
<template>
  <transition
      ...
      appear-active-class="origin-top-right transition transform duration-500 ease-in-out"
      leave-class="scale-100"
      leave-to-class="scale-0"
      leave-active-class="origin-top-right transition transform duration-500 ease-in-out"
  >
    <div v-if="!dismissed && !_.isNull(flash.status)"
