<template>
  <jet-action-section>
    ...
    <template #content>
      ...
      <div class="mt-3 max-w-xl text-sm text-zinc-600 dark:text-zinc-300">
        <p>
      ...
      <div v-if="twoFactorEnabled">
        ...
        <div v-if="recoveryCodes.length > 0">
          ...
          <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-zinc-100 dark:bg-zinc-900 dark:text-zinc-300 rounded-lg">
            <div
...
export default class TwoFactorAuthenticationForm extends Vue {
