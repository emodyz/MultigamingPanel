  ...
  <div class="h-40 rounded-lg bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-lg relative overflow-hidden">
    <div class="px-3 pt-8 pb-10 text-center relative z-10">
      ...
      <div v-if="stats.dailyDiff !== null">
        <p v-if="stats.isDailyDiffPositive" class="text-sm text-green-500 dark:text-emerald-500 leading-tight">▲ {{stats.dailyDiff}}% Today</p>
        <p v-else class="text-sm text-red-500 leading-tight">▼ {{stats.dailyDiff}}% Today</p>
      </div>
    </div>
