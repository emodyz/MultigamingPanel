...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::get('settings/update/check', [SettingsController::class, 'checkForCpUpdate'])->name('settings.update.check');
    Route::get('settings/upgrade', [SettingsController::class, 'upgradeCp'])->name('settings.upgrade.cp');
});
